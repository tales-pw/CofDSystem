...
class SystemSynchronizationTestCase extends haxe.unit.TestCase {
    public function testFullSync() {
        ...
        system1.weapons.register(new MeleeWeaponPrefab("weapon1", "", 1, 2, 3, 4, [AccurateTag.TYPE]));
        system1.weapons.register(new MeleeWeaponPrefab("weapon2", "", 5, 6, 7, 8, [BrawlTag.TYPE]));
        system1.weapons.register(new MeleeWeaponPrefab("weapon3", "", 9, 1, 0, 1, [AccurateTag.TYPE]));

        system1.weapons.register(new RangedWeaponPrefab("weapon4", "", 1, 1, 2, 1, [AccurateTag.TYPE]));
        system1.weapons.register(new RangedWeaponPrefab("weapon5", "", 3, 1, 4, 1, [BrawlTag.TYPE]));
        system1.weapons.register(new RangedWeaponPrefab("weapon6", "", 5, 1, 6, 1, [AccurateTag.TYPE]));
