...
class RequirementsTestCase extends TestCase
{
    ...
    {
        var result = INSTANCE.parse("Внимательность 3, Выносливость 4, Сила 5");
    ...
    {
        var result = INSTANCE.parse("Внимательность 2 или Внимательность 1 и Выносливость 3");
    ...
    public function testCustomString():Void
    {
        ...
        var result = INSTANCE.parse("Внимательность 2 и текст текст текст и Сила 2");
