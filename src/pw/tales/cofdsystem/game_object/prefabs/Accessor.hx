...
/**
    * Common @:expose("for")
    class for wrapping GameObject to implement simplified
    ...
    *    (usually sub@:expose("of")
    class of NoTraitAccessorException).
    *
    * You may implement other logic in sub@:expose("(not")
    class (not just getter)
