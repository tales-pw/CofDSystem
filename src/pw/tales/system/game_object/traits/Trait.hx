...
import pw.tales.system.game_object.events.traits.TraitPostDeserializeEvent;
...
import pw.tales.system.utils.serialization.AnnotationSerialization;
...
class Trait implements IRecord {
    ...
    **/
    ...
    public function getValue():Int throw new AbstractMethod();
    ...
    **/
    public function serialize():Dynamic throw {
