package pw.tales.system.action_attack.builder;

import pw.tales.system.action.IAction;
import pw.tales.system.action.modifications.Offhand;
import pw.tales.system.action.modifications.Willpower;
import pw.tales.system.action.opposition.base.OppositionCompetitive;
import pw.tales.system.action.opposition.builder.EnumOpposition;
import pw.tales.system.action.opposition.builder.OppositionBuilder;
import pw.tales.system.action_attack.modifications.AllOutAttack;
import pw.tales.system.action_attack.modifications.SpecifiedTarget;
