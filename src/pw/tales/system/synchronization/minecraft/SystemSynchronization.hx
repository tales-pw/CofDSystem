package pw.tales.system.synchronization.minecraft;

import pw.tales.system.synchronization.minecraft.serialization.ExternalArmorSerialization.ExternalArmorData;
import pw.tales.system.synchronization.minecraft.serialization.ExternalArmorSerialization;
import pw.tales.system.synchronization.minecraft.serialization.MeleeWeaponSerialization.MeleeWeaponData;
import pw.tales.system.synchronization.minecraft.serialization.TraitTypeSerialization;
import pw.tales.system.synchronization.minecraft.serialization.WeaponSerialization;
